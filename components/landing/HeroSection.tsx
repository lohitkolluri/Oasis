  ...
  return (
    <section className="relative overflow-hidden min-h-[90vh] flex flex-col justify-center pt-24 pb-16">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-5 flex flex-col items-center text-center z-10">
        ...
        >
          Oasis covers loss of income from external disruptions like extreme weather and locked
          zones. Weekly pricing. <span className="text-white/80">Zero manual claims.</span>
        </p>

        <div
          className="mt-10 reveal-in-up flex flex-col sm:flex-row gap-4"
      ...
      <div
        className="mt-20 mx-auto w-full max-w-[1200px] reveal-in-up px-0 sm:px-5 relative z-10 perspective-[2000px]"
