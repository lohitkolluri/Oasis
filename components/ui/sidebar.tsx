...
export function SidebarGroupLabel({
  ...
  const Comp = (asChild ? "div" : "div") as React.ElementType
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-hidden ring-sidebar-ring transition-[margin,opacity] duration-200 ease-linear [&>svg]:size-4 [&>svg]:shrink-0",
...
export function SidebarGroupAction({
  ...
  const Comp = (asChild ? "button" : "button") as React.ElementType
...
type SidebarMenuButtonBaseProps = React.ComponentProps<"button"> &
...
export function SidebarMenuSubButton({
  ...
  const Comp = (asChild ? "a" : "a") as React.ElementType
