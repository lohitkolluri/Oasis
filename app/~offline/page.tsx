  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-[#0b0e14] text-zinc-100">
      <div className="text-center max-w-sm">
        <div className="flex items-center justify-center w-20 h-20 rounded-full bg-surface-1 border border-white/10 mx-auto mb-6">
        ...
        {/* Cached info section */}
        <div className="rounded-[20px] bg-surface-1 border border-white/10/70 p-5 mb-6 text-left">
          <h2 className="text-[13px] font-semibold text-zinc-300 mb-3 flex items-center gap-2">
            <Shield className="text-uber-green" style={{ width: 14, height: 14 }} />
            While offline:
          </h2>
          <ul className="space-y-2.5 text-[12px] text-zinc-400">
            ...
            <li className="flex items-start gap-2">
              <Shield className="text-uber-green shrink-0 mt-0.5" style={{ width: 12, height: 12 }} />
